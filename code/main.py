...
# TODO: Accept a single argument *args and parse it automatically, instead of doing one-by-one
def visualize_meshes(mesh_airways, mesh_lungs_fill, mesh_skeleton):
    """
    Visualizes meshes with an interactive interface

    :param mesh_airways:
    :param mesh_lungs_fill:
    :param mesh_skeleton:
    :return:
    """
...
def main():
    ...
    visualize_meshes(mesh_airways, mesh_lungs_fill, mesh_skeleton)

    # TODO: Create a threshold slider widget
    #  https: // docs.pyvista.org / examples / 03 - widgets / slider - bar - widget.html  # slider-bar-widget
